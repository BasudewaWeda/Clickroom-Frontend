...
export default function MyScheduleInRoomDetails(props) {
    ...
    return (
        <div className="grid grid-cols-12 gap-2">
            ...
            <button onClick={deleteButtonClicked} className="group text-xl bg-sky-500 p-2 mb-3 rounded-lg font-bold hover:bg-zinc-50 hover:text-sky-500 transition-all ease-in duration-75">
                <svg className="w-8 h-8 fill-zinc-50 group-hover:fill-sky-500 transition-all ease-in duration-75" viewBox="0 0 25 25" version="1.1" xmlns="http://www.w3.org/2000/svg">
